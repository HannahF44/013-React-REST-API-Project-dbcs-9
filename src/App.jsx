        ...
        <section className="container">
         <div className="type1">
          ...
          <div className="description">
            <p>This app teaches you about Fire and Dark type Pokemon. It is also for entertainment purposes for those who are bored and just want to read about them.</p>
          </div>
          <div className="type2">
